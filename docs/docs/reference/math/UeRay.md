...
| --------------------------------------------------------------------------- | ------------------------ | --------------------------------------------------------------------------------------------- |
| `setFromPoints(from, to)`                                                   | `this`                   | Sets origin and direction based on two points                                                 |
...
| `copy(ray)`                                                                 | `this`                   | Copies origin and direction from another ray                                                  |
| `applyMatrix4(matrix4)`                                                     | `this`                   | Applies a 4x4 transformation matrix to origin and direction                                   |
...
| `lookAt(v)`                                                                 | `this`                   | Sets the ray direction to look at vector `v` (world space)                                    |
| `recast(t)`                                                                 | `this`                   | Moves the origin along the direction by distance `t`                                          |
| `set(origin, direction)`                                                    | `this`                   | Sets origin and normalized direction                                                          |
