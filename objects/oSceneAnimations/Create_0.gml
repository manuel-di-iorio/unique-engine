...
// Light
hemiLight = new UeHemisphereLight(c_gray, c_ltgray, undefined, { matrixAutoUpdate: false });
dirLight = new UeDirectionalLight(c_ltgray, 1, { x: 150, y: -200, z: 200, matrixAutoUpdate: false }); 
