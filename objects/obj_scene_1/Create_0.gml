...
var matPyramid = new UeMaterial({ map: texPyramid, shader: sh_ue_standard });
...
// Pyramids
var pyramid0 = new UeMesh(new UePyramidGeometry({ base: 160, height: 100 }), { material: matPyramid });
