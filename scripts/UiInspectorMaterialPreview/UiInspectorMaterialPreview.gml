function UiInspectorMaterialPreview(style = {}, props = {}): UiNode(style, props) constructor {
    ...
    self.onMaterialChange = function(event) {
    ...
    if (self.asset != undefined) {
        self.asset.on("change", self.onMaterialChange);
    }
    ...
    if (self.asset != undefined) {
        self.asset.on("change", self.onAssetChange);
    }
    ...
    self.onDestroy = function() {
        if (self.asset != undefined) {
            self.asset.off("change", self.onAssetChange);
        }
    };
    ...
    self.onDestroy = function() {
        if (self.asset != undefined) {
            self.asset.off("change", self.onMaterialChange);
        }
