...
| `setFromArray(arr)`                  | `this`      | Sets the box bounds from a flat array of 3D points                   |
| `setFromCenterAndSize(center, size)` | `this`      | Builds the box using a center point and size                         |
| `setFromPoints(points)`              | `this`      | Expands the box to fit a set of 3D points                            |
| `setFromObject(object, precise)`     | `this`      | Sets the box from an object's geometry (optionally precise)          |
...
| `expandByObject(object, precise)`    | `this`      | Expands the box to include an object's bounding box                  |
...
| `applyMatrix4(matrix)`               | `this`      | Applies a 4x4 transformation matrix to the box                       |
